...
namespace Program
{
    public class InitData
    {
        ...
        public InitData(bool isInit = true)
        {
            ...
            sectDual[1].D_st = 90;
            sectDual[1].D_fin = 90;
            sectDual[1].L_sect = 200;
            sectDual[1].step_ = 80;
            sectDual[1].H_st = 10;
            sectDual[1].H_fin = 10;
            sectDual[1].e_st = 15;
            sectDual[1].e_fin = 15;
            sectDual[1].delta = 0.01;
            sectDual[1].d_Fi = 0;
            sectDual[1].W_a = 0;
            ...
            sectDual[2].Order = 3;
            sectDual[2].Monolit = 1;
            sectDual[2].n_cykle = 50;
            sectDual[2].n_Line = 0;
            sectDual[2].R_or_L = 0;
            sectDual[2].p_W = 0;
            sectDual[2].D_st = 90;
            sectDual[2].D_fin = 60;
            sectDual[2].L_sect = 100;
            sectDual[2].step_ = 0;
            sectDual[2].H_st = 10;
            sectDual[2].H_fin = 8;
            sectDual[2].e_st = 0;
            ...
            // sect_aDual
            sect_aDual = new TypesDual.SECT_a[3];
            sect_aDual[0].S_Type = 1;
            sect_aDual[0].Order = 1;
            sect_aDual[0].Monolit = 1;
            sect_aDual[0].n_cykle = 0;
            ...
            sect_aDual[0].D_st = 90;
            sect_aDual[0].D_fin = 90;
            sect_aDual[0].L_sect = 700;
            sect_aDual[0].step_ = 90;
            sect_aDual[0].H_st = 16;
            sect_aDual[0].H_fin = 10;
            sect_aDual[0].e_st = 12;
            sect_aDual[0].e_fin = 12;
            sect_aDual[0].delta = 0.1;
            sect_aDual[0].d_Fi = 180;
            ...
            sect_aDual[1].D_st = 90;
            sect_aDual[1].D_fin = 90;
            sect_aDual[1].L_sect = 200;
            sect_aDual[1].step_ = 80;
            sect_aDual[1].H_st = 10;
            sect_aDual[1].H_fin = 10;
            sect_aDual[1].e_st = 12;
            sect_aDual[1].e_fin = 12;
            sect_aDual[1].delta = 0.01;
            sect_aDual[1].d_Fi = 0;
            sect_aDual[1].W_a = 0;

            sect_aDual[2].S_Type = 2;
            sect_aDual[2].Order = 3;
            sect_aDual[2].Monolit = 1;
            sect_aDual[2].n_cykle = 50;
            sect_aDual[2].n_Line = 0;
            sect_aDual[2].R_or_L = 0;
            sect_aDual[2].p_W = 0;
            sect_aDual[2].D_st = 90;
            sect_aDual[2].D_fin = 60;
            sect_aDual[2].L_sect = 100;
            sect_aDual[2].step_ = 0;
            sect_aDual[2].H_st = 10;
            sect_aDual[2].H_fin = 8;
            sect_aDual[2].e_st = 0;
            sect_aDual[2].e_fin = 0;
            sect_aDual[2].delta = 0;
            sect_aDual[2].d_Fi = 0;
            sect_aDual[2].W_a = 0;

            // cylinderDual
            cylinderDual = new TypesDual.CYLINDER[3];
            cylinderDual[0].L_sec = 600;
            cylinderDual[0].Del_k_ = 15;
            cylinderDual[0].T_W_k_ = 90;
            cylinderDual[0].Al_W_k_ = 350;
            cylinderDual[0].a_W_k_ = 1.4e-7;
            ...
            // dop_dataDual
            dop_dataDual.k_V_air = 0;
            dop_dataDual.Alfa_min = 0.65;
            dop_dataDual.Alfa_max = 0.85;
            dop_dataDual.n_Alfa = 2;
            ...
            resDual.t_op_eq = 540;
            resDual.n_Q = 2;
            resDual.MQ = new double[61];
            resDual.MQ[0] = 18.434080221;
            resDual.MQ[1] = 21.270092562;
            resDual.MQ[2] = 24.106104904;
            resDual.MP = new double[61];
            resDual.MP[0] = 13.868245715;
            resDual.MP[1] = 11.42778233;
            resDual.MP[2] = 4.6194658097;
            resDual.MT = new double[61];
            resDual.MT[0] = 121.91244177;
            resDual.MT[1] = 121.16268757;
            resDual.MT[2] = 118.83459286;
            resDual.MVUL = new double[61];
            resDual.MVUL[0] = 927.54469521;
            resDual.MVUL[1] = 780.25800551;
            resDual.MVUL[2] = 668.36061792;
