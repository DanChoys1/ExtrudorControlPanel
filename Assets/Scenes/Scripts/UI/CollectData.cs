...
public class CollectData : MonoBehaviour
{
    ...
    public InitData GetInitData()
    {
        ...
        initData.dataDual.nS_2 = initData.sectDual.Count((TypesDual.SECT sec) => sec.S_Type == 2); // гладкая
        initData.dataDual.nS_1a = initData.sect_aDual.Count((TypesDual.SECT_a sec) => sec.S_Type == 1); // нарезка
        initData.dataDual.nS_2a = initData.sect_aDual.Count((TypesDual.SECT_a sec) => sec.S_Type == 2); // гладкая
